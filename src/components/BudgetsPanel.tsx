          ...
          {budgets.map((b) => (
            ...
            >
              <div className="flex items-center gap-2">
                <span
                  className={clsx(
                    ...
                    b.ativa ? "bg-[var(--system-green)]" : "bg-muted",
                  )}
                  aria-hidden
                />
                <div>
              ...
              <div className="flex items-center gap-1">
                <Button variant="ghost" size="sm" className="rounded-full" onClick={() => openEdit(b)}>
                  <Pencil size={13} />
                </Button>
                <Button variant="ghost" size="sm" className="rounded-full" onClick={() => toggleBudget(b.id)}>
      ...
      {formOpen && (
        ...
        >
          ...
          >
            ...
            {error && (
              <p className="text-xs text-[var(--system-red)]">{error}</p>
            )}
