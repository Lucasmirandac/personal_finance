...
export const fieldClasses =
  "bg-surface border border-border rounded-md px-2.5 py-1.5 text-base text-foreground w-full focus:outline focus:outline-1 focus:outline-border-strong focus:border-border-strong"
